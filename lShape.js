class LShape {
    ...
    constructor(){
        ...
        this.currentPosition = [{x: 5, y: 0}, {x: 6, y:0}, {x: 6, y: 1}, {x: 6, y: 2}],
        
        this.rotateFromDownPosition = [{x: 2, y: 0}, {x: 1, y:1}, {x: 0, y: 0}, {x: -1, y: -1}]
        this.rotateFromLeftPosition = [{x: 0, y: 2}, {x: 1, y: -1}, {x: 0, y: 0}, {x: -1, y: 1}],
        this.rotateFromUpPosition = [{x: 1, y: 1}, {x: 0, y: 0}, {x: -1, y: -1}, {x: -2, y: 0}],
        this.rotateFromRightPosition = [{x: 1, y: -1}, {x: 0, y: 0}, {x: -1, y: 1}, {x: 0, y: -2}]
...
// down: 0 3 0   left: 2 3 4     up: 0 2 0     right: 1 2 3
//       0 4 0         0 0 0         0 3 4            4 0 0
