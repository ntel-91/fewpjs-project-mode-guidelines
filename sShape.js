class SShape {
    ...
    constructor(){
        ...
        this.currentPosition = [{x: 5, y: 1}, {x: 6, y:1}, {x: 4, y: 2}, {x: 5, y: 2}],
        
        this.rotateFromDownPosition = [{x: 0, y: 0}, {x: -1, y: 1}, {x: 0, y: -2}, {x: -1, y: -1}],
        this.rotateFromLeftPosition = [{x: 2, y: 0}, {x: 1, y: -1}, {x: 0, y: 0}, {x: -1, y: -1}],
        this.rotateFromUpPosition = [{x: 1, y: 1}, {x: 0, y: 2}, {x: 1, y: -1}, {x: 0, y: 0}],
        this.rotateFromRightPosition = [{x: 1, y: 1}, {x: 0, y:0}, {x: -1, y: 1}, {x: -2, y: 0}]
...
// down: 0 1 2   left: 2 3 0     up: 3 4 0     right: 0 2 3 
