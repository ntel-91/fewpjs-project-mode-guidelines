class ZShape {
    ...
    constructor(){
        ...
        this.currentPosition = [{x: 4, y: 1}, {x: 5, y:1}, {x: 5, y: 2}, {x: 6, y: 2}],
        
        this.rotateFromDownPosition = [{x: 1, y: -1}, {x: 0, y:0}, {x: -1, y: -1}, {x: -2, y: 0}],
        this.rotateFromLeftPosition = [{x: 1, y: 1}, {x: 1, y:-1}, {x: 0, y: 0}, {x: 0, y: -2}]
        this.rotateFromUpPosition = [{x: 2, y: 0}, {x: 1, y:1}, {x: 0, y: 0}, {x: -1, y: 1}],
        this.rotateFromRightPosition = [{x: 0, y: 2}, {x: 0, y:0}, {x: -1, y: 1}, {x: -1, y: -1}],
...
//   up: 0 3 4  right: 0 2 3   down: 1 2 0      left: 2 3 0 
//       0 0 0         0 4 0         0 3 4            4 0 0